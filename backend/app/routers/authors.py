...
@router.post("/", response_description="Add new author", response_model=Author, status_code=status.HTTP_201_CREATED)
def add_authors(author: BaseAuthor, db: Session=Depends(get_db)):
